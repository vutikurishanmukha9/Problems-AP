      ...
      <main>
        <div className="border-b border-line bg-surface">
          <div className="container-ap py-10">
            <h1 className="text-2xl font-semibold sm:text-3xl">Problem map</h1>
        ...
        <div className="container-ap py-8">
          <div
            className="mb-4 flex rounded-md border border-line bg-surface p-0.5 sm:hidden"
            role="group"
          ...
          >
            {(["map", "list"] as const).map((t) => (
              <button
                ...
                aria-pressed={tab === t}
                className={cn(
                  "h-10 flex-1 rounded text-sm capitalize",
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
            <div className={cn(tab === "list" && "hidden sm:block")}>
              <ProblemMap problems={problems} height="min(70vh, 620px)" />
            </div>
